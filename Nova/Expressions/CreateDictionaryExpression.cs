...
namespace Nova.Expressions {
    ...
    ///     TODO: Update summary.
    /// </summary>
    public class CreateDictionaryExpression : NovaExpression {
        ...
        public override Type Type {
            get { return typeof (NovaDictionary); }
        }

        public override Expression Reduce() {
            return Operation.CreateDictionary(typeof (NovaDictionary), Constant(Values));
        }
